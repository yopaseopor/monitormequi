...
[BD de referència](https://github.com/yopaseopor/monitorOSM/blob/main/data-raw/PPCC.tsv)
...
[BD de referència](https://github.com/yopaseopor/monitorOSM/blob/main/data-raw/territoris.tsv)
...
[BD de referència](https://github.com/yopaseopor/monitorOSM/blob/main/data-raw/comarques.tsv)
...
[BD de referència](https://github.com/yopaseopor/monitorOSM/blob/main/data-raw/municipis.tsv)
...
if (any(hi_ha_canvis) &&
  ...
  m <- missatge_telegram(missatge = "Hi ha canvis a [limits](https://yopaseopor.github.io/monitorOSM/web/limits.html).")
}
```
