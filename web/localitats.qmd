...
[BD de referència](https://github.com/yopaseopor/monitorOSM/blob/main/data-raw/loc_admin_centre_municipis.tsv)
...
if (any(hi_ha_canvis) &&
  ...
  m <- missatge_telegram(
    missatge = "Hi ha canvis a [localitats](https://yopaseopor.github.io/monitorOSM/web/localitats.html)."
  )
}
```
