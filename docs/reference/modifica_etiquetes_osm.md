...
`hashtags`. En el marc del projecte, `monitormequi`, pot ser bona idea
afegir el paràmetre `hashtags = "monitormequi"` per poder fer un
seguiment de les edicions. Vegeu
<https://wiki.openstreetmap.org/wiki/Changeset> per més detalls.
