...
taules <- mapply(function(x, nom) {
  url <- paste0("[", nom, "](https://github.com/yopaseopor/monitorOSM/blob/main/data-raw/", nom, ".tsv)")
...
[tiquet](https://github.com/yopaseopor/monitorOSM/issues) o un [PR](https://github.com/yopaseopor/monitorOSM/pulls)
...
([exemple](https://github.com/yopaseopor/monitorOSM/blob/main/data-raw/comarques.R)). També cal documentar la nova
taula ([exemple](https://github.com/yopaseopor/monitorOSM/blob/main/man/comarques.Rd)).

Per començar a monitorar la nova base de dades cal crear o afegir-la a un fitxer com [limits.qmd](https://github.com/yopaseopor/monitorOSM/blob/main/web/limits.qmd).
